...
If tools unavailable, surface and ask the principal to re-auth.

## The interview

Ask, one or two at a time:

1. **Who is asking and why now?** Principal-direct / advisor-dispatched / upstream-regression surfaced by tests / operator on a dev instance / research experiment?
...
## Driver
<principal-direct / advisor-dispatched / upstream-regression-from-tests / operator / research-experiment>
