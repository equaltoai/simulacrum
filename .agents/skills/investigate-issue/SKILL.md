...
## Proposed next skill
<investigate-issue again / fix directly / scope-need / route-upstream-issue / enforce-csp-and-graphql-first / validate-browser-contract / install-sim-instance / coordinate-framework-feedback / none — cross-repo report>
```
