...
and repo ownership boundaries needed to replace the legacy clone-shaped client
with the agent-first Simulacrum.
...
- reusable types and composition boundaries used by Simulacrum
...
The rewrite follows the Stitch project `13618047916752071397` and its
