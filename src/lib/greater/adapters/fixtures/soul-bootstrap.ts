...
export const project44SoulBootstrapSigning = {
	walletChallenge: {
		...
		messageHex: '0x50726f6a656374343477616c6c6574',
		canonicalJson: null,
		digestHex: null,
	...
	principalDeclaration: {
		...
		status: 'pending_signature',
		message: 'Declare the principal address for Project 44 bootstrap.',
		messageEncoding: 'utf8',
		messageHex: '0x50726f6a65637434347072696e636970616c',
		canonicalJson:
			'{"bodyId":"body-agent-zero","principal":"0x2222222222222222222222222222222222222222","source":"lesser"}',
		digestHex: '0xprincipal-digest-from-lesser',
		boundaryRequirementsJson: null,
	...
	finalize: {
		name: 'finalize',
		status: 'pending_signature',
		message: 'Sign the Lesser-provided finalize payload for Host publication.',
		messageEncoding: 'utf8',
		messageHex: '0x50726f6a656374343466696e616c697a65',
		canonicalJson:
			'{"registrationId":"registration-project-44","conversationId":"conversation-project-44","source":"lesser"}',
		digestHex: '0xfinalize-digest-from-lesser',
		boundaryRequirementsJson: '{"required":["wallet","principal","conversation"]}',
		registrationPreviewJson: '{"agentId":"host-soul-agent-project-44","bodyId":"body-agent-zero"}',
		finalizeRequestTemplateJson:
			'{"registrationId":"registration-project-44","expectedVersion":3,"issuedAt":"2026-06-12T12:10:00Z"}',
		signingMethod: 'eip712',
		signerAddress: project44SoulBootstrapIds.walletAddress,
		principalAddress: project44SoulBootstrapIds.principalAddress,
		version: 'finalize-v1',
